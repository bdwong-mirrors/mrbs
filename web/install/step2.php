...
/*
* MRBS Installation - Step 2 (Required)
* Add phpGACL tables & core data/settings.
*
* TO DO: 
*/

define("PHPGACL_DIR","../phpgacl/");

require_once '../defaultincludes.inc';
require_once '../mrbs_sql.inc';

$config_file = PHPGACL_DIR.'/gacl.ini.php';
...
<a href="step3.php"><b>Next - Install default permissions (Recommended)</b></a>
</div>
');
} else {
