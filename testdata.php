...
$sql_1 = "SELECT id FROM $tbl_area";
$prepared_query_1 = $mdb->prepareQuery($sql_1);
$sql_2 = "SELECT id FROM $tbl_room WHERE area_id = ?";
$prepared_query_2 = $mdb->prepareQuery($sql_2);
$sql_3 = "SELECT count(*) FROM $tbl_entry WHERE room_id = ?
         AND ((start_time between ? and ?)
         OR (end_time between ? and ?)
         OR (start_time = ? and end_time = ?))";
$prepared_query_3 = $mdb->prepareQuery($sql_3);
$sql_4 = "INSERT INTO $tbl_entry (id, room_id, create_by, start_time,
